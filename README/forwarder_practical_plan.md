...
- [X] Прогресс по чек-листу: **31 / 94** пунктов завершены (~33%).
- [ ] Осталось до завершения плана: **63** пункта.
- [ ] Ближайший фокус (чтобы ускорить закрытие плана):
  - [ ] Закрыть оставшийся негативный тест для `report_php` (endpoint недоступен).
  - [ ] Зафиксировать список вкладок с приоритетами P1/P2/P3.
