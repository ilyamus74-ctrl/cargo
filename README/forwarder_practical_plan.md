...
- [ ] Зафиксировать рабочий config для `report_php` как эталон.
- [ ] Проверить стабильность на 3 последовательных прогонах:
  - [ ] Прогон #1 успешен.
  - [ ] Прогон #2 успешен.
  - [ ] Прогон #3 успешен.
- [ ] Убедиться, что корректно возвращаются: `download`, `target_table`, `imported_rows`, `trace_log`, `step_log`.
...
- [ ] Негативный тест: пустой файл/неверный content-type -> понятная ошибка импорта.
