...
try {
    $routes = [
        'get_user_info'       => __DIR__ . '/api/users/user_settings_actions.php',
        'set_lang'            => __DIR__ . '/api/users/user_settings_actions.php',
        'get_user_panel_html' => __DIR__ . '/api/users/user_settings_actions.php',
        'view_users'          => __DIR__ . '/api/users/user_standard_actions.php',
        'form_new_user'       => __DIR__ . '/api/users/user_standard_actions.php',
    ...
    if ($action === '') {
        ...
        $route = $routes[$action] ?? __DIR__ . '/api/core_actions.php';
        require $route;
    }
