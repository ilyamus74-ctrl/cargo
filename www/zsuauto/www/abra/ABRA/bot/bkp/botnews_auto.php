...
$list_news=mysql_query("SELECT `name`,`main_url`,`url`,`preg_one`,`preg_link`,`preg_name`,`preg_anonce`,`preg_img`,`preg_text`,`preg_f_img` FROM `$_name_news_table`  ORDER BY `date_in` ASC ") or die ("Invalid:" . mysql_error());
