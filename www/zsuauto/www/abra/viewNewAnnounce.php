...
if(!empty($_SESSION['admin_user']['id'])){
    ...
    $smarty->assign("pageview","viewNewAnnounce");

    $preg_list="SELECT * FROM `zs_announce_auto` WHERE  `active_announce` IS NULL ".$addon." ".$addon2." ".$addon3." ".$addon4." ".$addon5." ORDER BY `id` ASC";
