...
//	print_r($_SERVER);
	...
	else if(in_array('view', $url_razborka, true)){
	//echo "PROVIDER";
	//print_r($url_razborka);
	//sleep(11);
	$_SESSION['secCode'] = md5(microtime(true));
	...
	else if(in_array('prigon-avto-dlya-viyskovih.html', $url_razborka, true)){
	//echo "PROVIDER";
	$_SESSION['secCode'] = md5(microtime(true));
	$smarty->assign("secCode",$_SESSION['secCode']);
		include_once("prigon-avto-dlya-viyskovih.php");
	}
