...
?>
      ...
      <div class="container">
        <div class="row align-items-center justify-content-center text-center">
          ...
          <div class="col-md-8" data-aos="fade-up" data-aos-delay="400">
            ...
            <h1 class="text-white font-weight-light text-uppercase font-weight-bold" data-aos="fade-up"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("mainTitleH1");?>
</h1>
            <p class="mb-5" data-aos="fade-up" data-aos-delay="100"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("mainTitle");?>
</p>
    ...
    <div class="site-section bg-image overlay" style="background-image: url('images/main_bg_sklad_2.jpg');" id="section-how-it-works">
      <div class="container">
      ...
      <div class="container">
        ...
        <div class="row mb-5 align-items-stretch">
          ...
          <div class="col-md-6 col-lg-4 mb-4 mb-lg-4" data-aos="fade-up" data-aos-delay="100">
            <div class="h-entry">
              <a href="single.html"><img src="images/main_bg_sklad_2.jpg" alt="Image" class="img-fluid"></a>
              <h2 class="font-size-regular"><a href="single.html">How Logistics Company Improve Spendings</a></h2>
              <div class="meta mb-4">by Jed Wilson <span class="mx-2">&bullet;</span> Jan 18, 2019 <span class="mx-2">&bullet;</span> <a href="#">News</a></div>
              <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Natus eligendi nobis ea maiores sapiente veritatis reprehenderit suscipit quaerat rerum voluptatibus a eius.</p>
            </div> 
