...
$_smarty_tpl->getSmarty()->getRuntime('Foreach')->restore($_smarty_tpl, 1);?>
  ...
  <option value="COLIBRI" data-country="AZ">COLIBRI</option>
  <option value="KOLLI" data-country="AZ">KOLLI</option>
  <option value="ASER" data-country="AZ">ASER</option>
  <option value="CAMEX" data-country="AZ">CAMEX AZ</option>
  <option value="CAMEX" data-country="GE">CAMEX GE</option>
  <option value="CAMEX" data-country="KG">CAMEX KG</option>
  <option value="KARGOFLEX" data-country="AZ">KARGOFLEX</option>
  <option value="CAMARATC" data-country="GE">CAMARATC</option>
  <option value="POSTLINK" data-country="AZ">POSTLINK</option>
                  </select>
  </div>
...
>
  (function () {
    ...
    if (config.buttons) {
      if (!config.buttons.scan_left_single)  config.buttons.scan_left_single = 'scan';
      if (!config.buttons.scan_right_single) config.buttons.scan_right_single = 'scan';
